...
const FooterHtml = ({ html }: { html: string }) => (
        ...
        <main className="terminal-main">
              ...
              <section className="terminal-section" id="education">
                ...
                <div className="experience-list">
                  {sanitizedConfig.educations.map((education) => (
                    <article
                      className="experience-row"
                      key={`${education.institution}-${education.degree}-${education.from}`}
                    >
                      <time>
          ...
          {sanitizedConfig.projects.external.projects.length > 0 && (
            <section className="terminal-section" id="projects">
              ...
              <div className="terminal-card-grid">
                {sanitizedConfig.projects.external.projects.map((project) => (
                  <a
          ...
          {sanitizedConfig.publications.length > 0 && (
            <section className="terminal-section">
              ...
              <div className="terminal-card-grid">
                {sanitizedConfig.publications.map((publication) => (
                  <a
                    className="terminal-card"
          ...
          <div>
            ...
            <span>
              {sanitizedConfig.footer ? (
                <FooterHtml html={sanitizedConfig.footer} />
              ) : (
